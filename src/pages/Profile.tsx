            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-primary/10 p-5 space-y-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-foreground/40">Email аккаунт</span>
                </div>
                {profile.email ? (
                  <div className="flex items-center gap-3 rounded-xl bg-primary/5 border border-primary/10 px-4 py-3">
                    <div>
                      <p className="text-xs font-black text-primary">Email привязан</p>
                      <p className="text-xs text-foreground/60">{profile.email}</p>
                    </div>
                  </div>
                ) : (
                  <p className="text-sm text-foreground/60">Email не привязан</p>
                )}
              </div>
